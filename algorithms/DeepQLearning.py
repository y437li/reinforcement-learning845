                    ...
                    if cfg.mode == 'train':
                        ...
                        for name_agent in name_agent_list:
                            ...
                            if switch_env:
                                ...
                                reward, crash,arrive = agent[name_agent].reward_gen(new_depth1, action, crash_threshold, thresh, debug, posit[name_agent].position.x_val,posit[name_agent].position.y_val,f_x_val,f_y_val,start_time,cfg)
